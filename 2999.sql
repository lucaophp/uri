...
SELECT
	base.nome,
	(
    	case round(base.salario_liquido, 2)
    	when 0.00 then '0'
    	else round(base.salario_liquido, 2)
    	end
	) as "salario"
    
FROM
	base
    	INNER JOIN empregado ON empregado.matr = base.matr
...
WHERE
    ...
    AND salario_liquido >= 8000
ORDER BY
    base.cod_divisao ASC empregado.lotacao_div ASC, empregado.matr;
